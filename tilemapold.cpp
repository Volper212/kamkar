...
constexpr int treeSizeLog2 = 5;
constexpr int treeSize = 1 << treeSizeLog2;

constexpr int chunkSizeLog2 = 6;
constexpr int chunkSize = 1 << chunkSizeLog2;
...
constexpr int tilemapHalfSize = 1 << (treeSizeLog2 * maxDepth);

constexpr int tilemapTotalSize = 1 << (treeSizeLog2 * maxDepth + chunkSizeLog2);
static_assert(tilemapTotalSize > 0, "tilemap size exceeds 32 bit unsigned integer limit");
